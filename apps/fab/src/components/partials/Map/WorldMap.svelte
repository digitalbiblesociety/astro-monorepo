	...
	<div
		...
		<div
			...
			<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 952.4 952.4">
				<path
					fill="#fff"
					d="M35 509.4C63.3 565.8 89.6 627 80.2 687c-.8 5.2 3.3 10 8.7 10h39c2.7 0 5.3-1.3 7-3.5 47.2-64 111.2-84 111.2-84 57.8-17.4 120-32.8 160-32.8 74.7 0 92.5 61.2 96.5 84.6 1 5.2 5.4 9 10.7 9 4.8 0 9.4-2 12.6-5.6l34.7-38.4c3.5-3.8 9.8-2 10.6 3 10.7 67.2 63.5 136.4 73.5 141.8 1 .6 2 .8 3 .8h155c3.2 0 5.8-2.4 6-5.5 5.6-58.8 95.8-143.7 130.3-174.3 8.6-7.5 13.4-18.2 13.4-29.5v-74c0-1-.2-2-.6-3l-88-176c-.6-1.2-1.7-2.2-3-2.8-72-33-68.2-115-66.8-130 0-1.4-.3-3-1.2-4.2L771.6 145c-2-2.7-5.8-3.3-8.5-1.3l-9.6 7c0-42.6-17.7-79-27.6-96.3-2.6-4.5-9.2-4-11 .8l-20.3 52.2c-.3.7-.4 1.5-.4 2.2 0 43.3-7.2 72.4-15 91-6.8 17-27.3 23-42.5 13.2l-95-62c-3-2-3.7-6.2-1.4-9L587 86c3.3-4 .4-10-4.8-10H436.6c-1.6 0-3 .5-4.2 1.6l-47.7 45c-2.5 2.4-2.6 6.4 0 8.8L397 144c-40.6 13.6-68-13.8-77.7-26-2.3-3-6.5-3.2-9-.7L206 217.8c-.8 1-1.5 2-1.7 3.3C193.3 284.7 71 328 32.7 340c-7 2.2-12.5 8-14.2 15.2l-18 74.6c-1 4.7-.5 9.6 1.5 14 9.8 20.8 21.5 43 33 65.8z">
				</path>
			</svg>
		</div>
		<div
		...
		<div
			...
			<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 500" fill="#fff">
				...
				<path
					d="M128.6 324c20-4 10.4-12.7 10.4-12.7l.5-10.4 1-9 10.8-1s13 5 6 11c-7.3 6-8.3 13-8.3 13s-1 25 15.6 20H184v-4l9.7-7v-16s-6.2-7-8-13c-1.8-6-6.7-16-6.7-16l-14.7-19v-25l-2-5 4.4-9 4-12s-1.7-6-15.7 13.3-22.2 15.4-25 19.5c-2.6 4-3.5 14.5 3.7 18.6 7.2 4 4 15-5.7 16.5s-20.2 18-19 26c1.5 8-.3 24 19.6 20zm104.8-86.6h18c0-8.6 11-18 11-18l6-4.6L275 226l7.3 3.7L285 247v17s0 7.3 6.3 8.6c6.3 1.3 29.4-22.5 29.4-22.5l-4.5-6s-1-12 6.6-17c7.5-5 5.7-17 5.3-19 0-2-8-10-8-14s4-24 4-24 10-12 16-14c7-2 9-8 9-8s2-21 13-27.2c12-7 19 4 19 4l-2 9-8 11s-10 4.7-16 22-.4 37-.4 37 2.5 4.6 3 7.4c.4 2 3 1 6.6 0s12 0 12 0h9c2 0 6-8 6-8l11.4-1c11.6-1 5.2-1 7-3 1-2 1-6 1-6l1-6 9.5-6.8v-32l-1.6-1.6-3-5.4V122l-2.5-10-2.7-7-1-12.4V83c6-12.3-4.5-19-4.5-19 3.7-16.4 8-37.8 8-37.8-9-46-74.6 3-74.6 3l-39 40-6 35-16 27-43 40-5.4 8-5 18 3 34 6 8zm-195-130c-5.4 2-8.5 5.7-8.5 5.7s-8 2-8-3-6-7-6-7l-10 1-7 11 4 8 9 4 3 12s-2 4 10 15c12 11.5 51-19 51-19 6-42-33-27.2-39-25.3z">
				</path>
			</svg>
		</div>
	</div>
