...
{#if country}
	<TabGroup as="div">
		<div
			class="flex flex-col bg-gradient-to-br from-primary-500 to-secondary-500 dark:from-primary-700 dark:to-secondary-700 xl:rounded-tl-xl xl:rounded-tr-xl text-stone-100 text-2xl text-center">
			<h1
									...
									{#if rows}
										{#each $rows as row}
											<tr>
												...
												<td
													class="hidden whitespace-nowrap px-6 py-4 text-sm font-medium text-stone-900 sm:table-cell"
												>
													{row.iso}
												</td>
											</tr>
								...
								>
									...
									<div class="min-w-0 flex-1">
										...
										>
											...
											<p class="text-sm font-medium text-stone-900 dark:text-stone-200">
												{country_map.title}
											</p>
