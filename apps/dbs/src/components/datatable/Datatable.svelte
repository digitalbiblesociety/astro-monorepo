<script>
	...
	import { alphabetsColumns, biblesColumns, countriesColumns, filmsColumns, resourcesColumns, organizationsColumns, languagesColumns, languagebiblesColumns, countryLanguagesColumns} from './DatatableColumns.js'
