<script>
	...
	<Menu>
		<MenuButton class="flex rounded-md mt-2 p-1 md:px-2.5 text-sm text-gray-700 dark:bg-gray-600 dark:text-gray-200" aria-label="Language Select">
			 <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="h-5 w-5 dark:placeholder-gray-400 md:mr-2">
